...
#+BEGIN_SRC emacs-lisp
  ...
  (defun ht/set-faces (&optional frame)
    ...
    (set-face-attribute 'variable-pitch nil :font "CMU Sans Serif")
    ;; override Org mode faces
    (dolist (face '((org-level-1 . 1.2)
                    ...
                    (org-level-7 . 1.1)
                    (org-level-8 . 1.1)))
      (set-face-attribute (car face) nil :font "CMU Sans Serif" :weight 'medium :height (cdr face)))
